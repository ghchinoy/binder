...
func TestGenerateIndexesDefaultUnchanged(t *testing.T) {
	...
	def := GenerateIndexes(concepts, okf.DefaultSpecVersion, IndexOptions{})
	...
	grouped := GenerateIndexes(concepts, okf.DefaultSpecVersion, IndexOptions{GroupByType: true})
...
func TestGenerateIndexesIdempotent(t *testing.T) {
	...
	a := GenerateIndexes(catalogFixture(), okf.DefaultSpecVersion, opts)
	b := GenerateIndexes(catalogFixture(), okf.DefaultSpecVersion, opts)
	if len(a) != len(b) {
