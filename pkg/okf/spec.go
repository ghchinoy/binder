...
//
// SpecVersion itself is part of the published okf vocabulary; the spec-rule
// introspection (specRules/rules/knownVersion) is a keep-internal implementation
// detail (design Decision 2 / Phase-2 trace), so only DefaultSpecVersion is
// exported alongside the type.
